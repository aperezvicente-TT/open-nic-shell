# *************************************************************************
# CMAC 1 for BittWare XUP-VV8 (VU13P)
# Maps to QSFP-DD port 3 upper lane group.
#   GTY Bank 129 -> lanes X0Y36..X0Y39
#   Hard CMAC tile: CMACE4_X0Y7 (SLR=1, same SLR as PCIe and CMAC0)
#   Reference clock from Si5346-A (322.265625 MHz) into refclk0 of bank 129.
# *************************************************************************
...
set_property -dict {
    ...
    CONFIG.GT_GROUP_SELECT {X0Y36~X0Y39}
    CONFIG.LANE1_GT_LOC {X0Y36}
    CONFIG.LANE2_GT_LOC {X0Y37}
    CONFIG.LANE3_GT_LOC {X0Y38}
    CONFIG.LANE4_GT_LOC {X0Y39}
