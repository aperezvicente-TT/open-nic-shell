...
#
# *************************************************************************
# AXI-Lite CDC: 125 MHz slave (axil_aclk) → 250 MHz master (axis_aclk)
# Used to cross the QDMA bridge CSR programming bus from the system AXI-Lite
# domain into the QDMA IP's 250 MHz domain.
