...
set_property -dict { 
    ...
    CONFIG.M13_A00_BASE_ADDR {0x0000000000014000}
...
if {[info exists rdma] && $rdma} {
    ...
    #   M13 ERNIC0 @ 0x800000 (2 MB)  — overrides base M13 (0x14000 QDMA CSR)
    #   M14 ERNIC1 @ 0xA00000 (2 MB)
    #   M15 QDMA[0] CSR bridge @ 0x14000 (4 KB)  — DMA window table programming
    set_property -dict {
        CONFIG.NUM_MI {16}
        ...
        CONFIG.M15_A00_BASE_ADDR {0x0000000000014000}
