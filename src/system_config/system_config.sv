...
`endif
  ...
  system_config_address_map #(
    ...
    .m_axil_ptp_awvalid  (m_axil_ptp_awvalid),
    .m_axil_ptp_awaddr   (m_axil_ptp_awaddr),
    .m_axil_ptp_awready  (m_axil_ptp_awready),
    .m_axil_ptp_wvalid   (m_axil_ptp_wvalid),
    .m_axil_ptp_wdata    (m_axil_ptp_wdata),
    .m_axil_ptp_wready   (m_axil_ptp_wready),
    .m_axil_ptp_bvalid   (m_axil_ptp_bvalid),
    .m_axil_ptp_bresp    (m_axil_ptp_bresp),
    .m_axil_ptp_bready   (m_axil_ptp_bready),
    .m_axil_ptp_arvalid  (m_axil_ptp_arvalid),
    .m_axil_ptp_araddr   (m_axil_ptp_araddr),
    .m_axil_ptp_arready  (m_axil_ptp_arready),
    .m_axil_ptp_rvalid   (m_axil_ptp_rvalid),
    .m_axil_ptp_rdata    (m_axil_ptp_rdata),
    ...
    .m_axil_qdma_csr_wstrb   (m_axil_qdma_csr_wstrb),
