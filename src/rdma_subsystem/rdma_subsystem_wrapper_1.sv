...
module rdma_subsystem_wrapper_1 #(
  ...
  output    [12:0] resp_hndler_o_send_cq_db_addr,
  ...
  output    [12:0] rx_pkt_hndler_o_rq_db_addr,
...
endmodule : rdma_subsystem_wrapper_1
