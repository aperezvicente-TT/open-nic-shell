...
p2p_322mhz #(
  ...
  .s_axis_adap_tx_322mhz_tuser_ptp_tag (s_axis_adap_tx_322mhz_tuser_ptp_tag),
  ...
  .m_axis_adap_rx_322mhz_tuser_ptp_ts  (m_axis_adap_rx_322mhz_tuser_ptp_ts),
  ...
  .m_axis_cmac_tx_tuser_ptp_tag        (m_axis_cmac_tx_tuser_ptp_tag),
  ...
  .s_axis_cmac_rx_tuser_ptp_ts         (s_axis_cmac_rx_tuser_ptp_ts),
