...
# ===========================================================================
# Ported from constr/au200/timing.xdc (2026-07-30).
#
# Everything below is device-INDEPENDENT: it references clocks and cell names,
# never pins or clock regions, so it applies unchanged to xcu250.  The pblocks
# further down are NOT ported -- their CLOCKREGION coordinates are specific to
# this device and au250 already has its own.
#
...
#     them an au250 build can fail outright (docs Ch. 6 §6.5).
